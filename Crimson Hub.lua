-- works for ninja legends and prison life 
-- made by XNub and Crimson
--Crimson Hub
if game.PlaceId == 155615604 then
    ...
    MainSection:NewDropdown("Give Gun", "Kinda Broken but eh", {"M9", "Remington 870", "AK-47"}, function(v)
        local A_1 = game:GetService("Workspace")["Prison_ITEMS"].giver[v].ITEMPICKUP
        local Event = game:GetService("Workspace").Remote.ItemHandler
        Event:InvokeServer(A_1)
    end)
    MainSection:NewDropdown("Gun Mod", "carefull this can lag the server ik u want that", {"M9", "Remington 870", "AK-47"}, function(v)
        local module = nil
    ...
    PlayerSection:NewSlider("Walkspeed", "Sets Your Walk Speed", 250, 16, function(v)
        game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = v
    end)
    PlayerSection:NewSlider("Jumppower", "Sets Your jump power", 250, 50, function(v)
